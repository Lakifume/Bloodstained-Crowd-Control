...
public class Bloodstained : SimpleTCPPack
{
    ...
    public override EffectList Effects => new List<Effect>
    {
        ...
        new("Shrink Player",        "ShrinkPlayer")        {Description = "Turn stealth mode on",                                                                                        Category =   "Timed", Price =  8, Duration = 30},
        ...
        new("Summon Rave",          "SummonRave")          {Description = "It's party time at the demon castle !",                                                                       Category =   "Timed", Price =  8, Duration = 30},
        ...
        new("Trigger Earthquake",   "TriggerEarthquake")   {Description = "Bloodstained go brrr",                                                                                        Category =   "Timed", Price =  8, Duration = 20},
