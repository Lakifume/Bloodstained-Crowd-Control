...
public class Bloodstained : SimpleTCPPack
{
    ...
    public override EffectList Effects => new List<Effect>
    {
		...
		new("Gold Rush",            "GoldRush")            {Description = "Call upon the player's thirst for gold, converting damage dealt to money at the cost of draining their currency", Category = "Main", Price =  300, Duration = 60},
